...
const DeleteActivityBatchStudents = props => {
  const { id, students } = props;
  const URL =
    strapiConstants.STRAPI_DB_URL +
    strapiConstants.STRAPI_ACTIVITY_BATCH_URL +
    `/${id}/` +
    strapiConstants.STRAPI_DELETE_STUDENT_ACTIVITY_BATCH_URL;
  ...
  const deleteData = () => {
    const body = { students };
    serviceProviders
      .serviceProviderForPostRequest(URL, body)
      .then(() => {
...
export default DeleteActivityBatchStudents;
