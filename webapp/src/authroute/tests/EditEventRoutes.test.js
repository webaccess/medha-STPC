...
import EditEventRoutes from "../EditEventRoutes";
...
describe("Testing EditEventRoutes", () => {
  let props;
  let wrapper;
  ...
  it(" renders without crashing when auth is set", () => {
    ...
    wrapper = shallow(<EditEventRoutes {...props} />);
  ...
  it(" renders without crashing to view event when dataForEdit is null", () => {
    localStorage.clear();
